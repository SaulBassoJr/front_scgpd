    ...
    return(
        <form className={styles.form}>
            ...
            <div className={styles.par}>
                ...
                <Input handleOnChange={(event) =>setFormData((e) => ({ ...e, rg: event.target.value}))}
                    type="float" text="*Valor Detran" name="valor" placeholder="Insira o valor do Detran"/>
                <Input handleOnChange={(event) =>setFormData((e) => ({ ...e, rg: event.target.value}))}
                    type="float" text="*Valor Despachante" name="valor" placeholder="Insira o valor da Despachante"/>
            </div>
            <div className={styles.par}>
